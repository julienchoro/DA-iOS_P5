...
// Protocol for Transaction Service
protocol AllTransactionServiceProtocol {
    // Function to fetch all transactions with token
    func fetchAllTransactions(token: String) async throws -> AccountDetails
}


// Structure conforming to AllTransactionServiceProtocol
struct AllTransactionService: AllTransactionServiceProtocol {
    // Function to fetch all transactions with token
    func fetchAllTransactions(token: String) async throws -> AccountDetails {
